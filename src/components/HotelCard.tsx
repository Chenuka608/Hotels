...
export default function HotelCard({ name, location, image, rating, reviews, price, description, amenities }: HotelCardProps) {
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
      {/* Image Container */}
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mt-6 pt-6 border-t-2 border-gray-100">
          ...
          <button className="bg-gradient-to-r from-amber-400 to-amber-600 text-white font-bold py-2 px-6 rounded-full hover:shadow-lg hover:shadow-amber-500/50 transition-all duration-300 transform hover:scale-105">
            View Details
          </button>
        </div>
      </div>
